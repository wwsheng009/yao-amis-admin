...
install_plugins() {
    ...
    log "下载soy-admin包"
    echo "正在下载soy-admin包..."
    curl -# -fL "https://github.com/wwsheng009/soybean-admin-amis-yao/releases/download/1.3.13/soy-yao-admin.zip" -o public/soy-admin/latest.zip || { log_error "下载soy-admin失败"; exit 1; }
    log "解压soy-admin包"
