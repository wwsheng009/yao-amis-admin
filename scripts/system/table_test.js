    ...
    children: [
      {
        ...
        children: [
            ...
            children: [
              {
                name: "type.mod.json",
                data: {
                  DSL: "models/ddic/model/column/type.mod.json",
                  ID: "ddic.model.column.type",
                  columns: [
                    {
                      label: "标识",
                      name: "id",
                  ...
                  values: [
                    ...
                    {
                      name: "timestampTz[带时区的时间戳]",
                      type: "timestampTz",
                    },
                    {
                      name: "tinyInteger[微整型]",
                      type: "tinyInteger",
                    },
                    {
                      name: "tinyIncrements[无符号微整型+自增]",
                      type: "tinyIncrements",
                    },
                    {
                      name: "unsignedTinyInteger[无符号微整型]",
                      type: "unsignedTinyInteger",
                    },
                    {
                      name: "smallInteger[小整型]",
                      type: "smallInteger",
                    },
                    {
                      name: "smallIncrements[无符号小整型+自增]",
                      type: "smallIncrements",
                    },
                    {
                      name: "unsignedSmallInteger[无符号小整型]",
                    ...
                    {
                      name: "increments[无符号整型+自增]",
                      type: "increments",
                    },
                    {
                      name: "unsignedInteger[无符号整型]",
                    ...
                    {
                      name: "bigIncrements[无符号长整型+自增]",
                      type: "bigIncrements",
                    },
                    {
                      name: "unsignedBigInteger[无符号长整型]",
                    ...
                    {
                      name: "decimal[小数(一般用于存储货币)]",
                      status: "enabled",
                      type: "decimal",
                    },
                    {
                      name: "unsignedDecimal[无符号小数 (一般用于存储货币)]",
          ...
          {
            name: "element.mod.json",
            data: {
              DSL: "models/ddic/model/element.mod.json",
              ID: "ddic.model.element",
              columns: [
                {
                  label: "ID",
                  name: "id",
                  ...
                  validations: [
                    {
                      args: ["enabled", "disabled"],
                      message:
                        "::{{input}} Error, {{label}} should be enabled/disabled",
                      method: "enum",
                    },
                  ],
                },
          ...
          {
            name: "relation.mod.json",
            data: {
              DSL: "models/ddic/model/relation.mod.json",
              ID: "ddic.model.relation",
              columns: [
                {
                  label: "ID",
                  name: "id",
