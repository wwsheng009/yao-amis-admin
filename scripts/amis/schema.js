        ...
        bulkActions: [
          {
            ...
            dialog: {
              ...
              body: {
                type: "form",
                api: "post:/api/v1/table/" + table + "/bulkUpdate/$ids",
                controls: [
                  {
                    type: "text",
                    name: "engine",
          ...
          },
          {
            ...
            level: "danger",
            actionType: "ajax",
            api: "delete:/api/v1/table/" + table + "/delete/$ids",
            confirmText: "确定要批量删除?",
          },
        ],
        columns: [
            ...
            buttons: [
              {
                ...
                buttons: [
                  ...
                  },
                  {
                    ...
                    actionType: "ajax",
                    confirmText: "您确认要删除?",
                    api: "post:/api/v1/table/" + table + "/delete/$id",
                  },
                ],
              },
            ],
    ...
    body: [
      {
        type: "form",
        mode: "horizontal",
        initApi: "/api/v1/table/" + table + "/find/${params.id}",
        controls: [...fields],
      },
    ],
  };
    ...
    body: [
      {
        ...
        mode: "horizontal",
        initApi: "/api/v1/table/" + table + "/find/${params.id}",
        api: "/api/v1/table/" + table + "/update/$id",
        redirect: `/crud/${table}/list`,
        controls: [...fields],
      },
    ],
